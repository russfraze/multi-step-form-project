        ...
        <div>
            ...
            <Card outlined={true} selectable={true} id='arcade'>
                <div className='flexGroup'>
                    ...
                    <div>
                        <h2>Arcade</h2>
                        {checked ? <p>$90/yr</p> : <p>$9/mo</p>}
                        {checked && <p>2 months free</p>}
                    </div>
                </div>
            </Card>

            <Card outlined={true} selectable={true} id='avanced'>
                <div className='flexGroup'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                    ...
                    <div>
                        <h2>Advanced</h2>
                        {checked ? <p>$120/mo</p> : <p>$12/mo</p>}
                        {checked && <p>2 months free</p>}
                    </div>
                </div>
            </Card>

            <Card outlined={true} selectable={true} id='pro'>
                <div className='flexGroup'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
